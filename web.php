...
//     Route::get('/', [WeightCapacityController::class, 'index'])->name('user.index');

//     Route::get('/add', [WeightCapacityController::class, 'add'])->name('user.add');
//     Route::post('/store', [WeightCapacityController::class, 'store'])->name('user.store');

//     Route::get('/edit/{id}', [WeightCapacityController::class, 'edit'])->name('user.edit');
//     Route::post('/update/{id}', [WeightCapacityController::class, 'update'])->name('user.update');

//     Route::get('/delete/{id}', [WeightCapacityController::class, 'delete'])->name('user.delete');
// });
