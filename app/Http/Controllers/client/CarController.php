...
class CarController extends Controller
{
    public function getCar($slug){
        ...
        $car_detail = Car::select('cars.id', 'cars.name','cars.price', 'cars.avatar', 'cars.slug', 'cars.producing_year', 'cars.images',
                    ...
                    'performances.trim',
                    'performances.torque',
                    'performances.cylinders',
                    'performances.standard_mpg',
                    'performances.transmission',
                    'performances.transmission_type',
                    'interiors.front_headroom',
                    'interiors.rear_headroom',
                    'interiors.front_legroom',
                    'interiors.rear_legroom',
                    'interiors.front_shoulder_room',
                    'interiors.rear_shoulder_room',
                    'exteriors.length',
                    'exteriors.width',
                    'exteriors.height',
                    'exteriors.wheelbase',
                    'weights_capacities.fuel_capacity',
                    'weights_capacities.cargo_capacity',
