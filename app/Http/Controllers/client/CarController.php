...
class CarController extends Controller
{
    public function getCar($slug)
    {
        ...
        $related_cars = Car::where('slug', '!=', $slug)
            ->where('manufacturer_id', $car_detail->manufacturer_id)
            ->get();
