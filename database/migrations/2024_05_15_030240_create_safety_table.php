...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('safety', function (Blueprint $table) {
            ...
            $table->foreignId('IIHS_best_pick')->nullable();
